<li class="mb-3 nav-item {{request()->is(trim(route('admin.'.$name.'.index', [], false), '/*').'*') || request()->is(trim(route('admin.'.$name.'.index', [], false))) ? 'menu-is-opening menu-open': false}}">
    <a href="" class="toggle-menu nav-link {{request()->is(trim(route('admin.'.$name.'.index', [], false), '/*').'*') || request()->is(trim(route('admin.'.$name.'.index', [], false))) ? 'active': false}}">
